...
script starts Flask web app
    ...
    routes: /:                    display "Hello nope!"
            ...
            /nope_filters:        disp HTML w/ working state, city filter
            /nope:                disp HTML w/ working property, amenity filter
"""
...
def html_filters():
    ...
    return render_template('10-nope_filters.html',
...
def html_all_filters():
    ...
    return render_template('100-nope.html',
                           state_objs=state_objs,
